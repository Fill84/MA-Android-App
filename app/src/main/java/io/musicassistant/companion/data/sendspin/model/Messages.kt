...
data class ClientHelloPayload(
    ...
    @SerialName("artwork_support") val artworkV1Support: ArtworkSupport? = null,
    @SerialName("visualizer_support") val visualizerV1Support: VisualizerSupport? = null
)
    ...
    companion object {
        val current: DeviceInfo by lazy {
            DeviceInfo(
                ...
                manufacturerId = android.os.Build.BRAND,
...
@Serializable
data class ArtworkSupport(val dummy: Int = 0)

@Serializable
data class VisualizerSupport(val dummy: Int = 0)
